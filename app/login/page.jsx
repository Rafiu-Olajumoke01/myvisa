...
function LoginPage() {
  ...
  const searchParams = useSearchParams();   // 👈 read the URL params
  ...
  const handleSubmit = async (e) => {
    ...
    // TODO: swap this block with your real Django API call
    // e.g. await fetch('/api/auth/login', { method: 'POST', body: ... })
    console.log('Logging in...', formData);

    // ✅ Read the ?redirect= param from the URL
    // If user clicked /package/3 before logging in, this will be "/package/3"
    // If they came to login directly, fall back to '/packages'
