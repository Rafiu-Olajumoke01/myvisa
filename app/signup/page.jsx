...
function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // After successful registration, check if user was trying to apply for a package
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="text-[#07b3f2] font-medium hover:underline">
                Login
              </Link>
            </p>
          </div>
        ...
        {/* Back to Home */}
        <div className="text-center mt-6">
          <Link href="/" className="text-sm text-gray-600 hover:text-[#07b3f2]">
            ← Back to packages
          </Link>
        </div>
      </div>
